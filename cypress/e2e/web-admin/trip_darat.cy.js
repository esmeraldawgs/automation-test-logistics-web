describe('buat pengiriman darat', () => {
  //Author : Esmeralda Wangsa
  
  it('buat pengiriman darat', () => {
      ...
      // Langkah 4: Mencari Pengiriman Darat
      cy.get('input[placeholder="Cari Page,ID Order,ID Trip"]').type('Pengiriman Darat{enter}');
      cy.wait(25000);
      ...
      cy.contains('b', 'Nama Transporter').closest('div[style="display: flex; flex-direction: column;"]').click();
